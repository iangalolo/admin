...
<!-- End of Sidebar -->
    ...
    <head>
        <section class = "buttong">
        <button class="btn btn-secondary" onclick = "myfun()">PRINT PAGE</button>
        ...
        <a class="btn btn-primary" href="Prices.php">ADD RECORDS</a>
    </section>
        <section class="boxing">
    <table class = "table table-bordered border-primary table-dark ">
            <thread>
            <tr>
                <th scope ="col">Regular GAS</th>
            ...
            ?>
                <tbody>
                    <tr>
                        <td> <?php echo $rows['rgas']; ?></td>
                        <td> <?php echo $rows['pgas']; ?></td>
                        <td> <?php echo $rows['diesel']; ?></td>
