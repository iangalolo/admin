...
<li class="nav-item">
    <a class="nav-link collapsed" href="productentry.php" >
...
<html>
    <style>
      ...
      <body> 
        ...
        <a class="btn btn-success" href="shellproduct.php"> ADD PRODUCT </a>
    </section>
...
<?php
include('includes/scriptmain.php');
